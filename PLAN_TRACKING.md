# Plan Tracking — Finalize Docs

- [x] 1. Update `API_REFERENCE.md` — fix Enums, attachment types, login example domain, envelope per_page
- [x] 2. Update `README.md` — fix attachment allowed types
